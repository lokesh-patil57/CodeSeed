    ...
    <>
      ...
      >
        ...
        <div className="px-3 py-4 border-b flex items-center justify-between" style={{ borderColor: `rgba(255,255,255,${isDark ? 0.05 : 0.05})` }}>
          <div className="flex items-center gap-2 flex-1">
            ...
            <span className={`font-bold text-sm ${textPrimary} hidden md:block`}>
              CodeSeed
            </span>
          </div>
          ...
          <button
            onClick={onToggle}
            title={isOpen ? "Close sidebar (Ctrl+.)" : "Open sidebar"}
            className={`
          ...
          >
            {isOpen || true ? (
              ...
              <Menu size={18} className={textSecondary} />
            )}
          </button>
        </div>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className={`
            fixed md:hidden bottom-6 left-6 z-40
